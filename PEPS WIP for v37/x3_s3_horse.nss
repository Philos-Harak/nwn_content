/*//////////////////////////////////////////////////////////////////////////////
 ...
 Programmer: Philos
////////////////////////////////////////////////////////////////////////////////
    We highjack the horse feats to allow the player to start the Enhanced player system!
...
void main()
{
   ...
   //*********** Philos Player Setup *********
   if(ai_GetIsCharacter(oPC)) ai_CheckPCStart(oPC);
   else if(ai_GetIsDungeonMaster(oPC)) ai_CheckDMStart(oPC);
   //*********** Philos Player Setup *********
