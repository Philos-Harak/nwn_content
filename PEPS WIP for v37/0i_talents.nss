...
int ai_TryPolymorphSelfFeat(object oCreature)
{
    ...
    else if(GetHasFeat(FEAT_ELEMENTAL_SHAPE))
    {
        ...
        if(AI_DEBUG) ai_Debug("0i_talents", "921", " Using Elemental shape feat: " + IntToString(nSubFeat));
    ...
    else if(GetHasFeat(FEAT_WILD_SHAPE))
    {
        ...
        if(AI_DEBUG) ai_Debug("0i_talents", "944", " Using wild shape feat: " + IntToString(nSubFeat));
