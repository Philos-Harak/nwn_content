...
void ai_OnMonsterSpawn(object oCreature, int bIncorporeal)
{
    ...
    //ai_Debug("0i_replace_j_ai", "43", GetName(oCreature) + " nearest enemy: " + GetName(oEnemy) +
    ...
    if(oEnemy != OBJECT_INVALID && GetDistanceBetween(oCreature, oEnemy) < AI_RANGE_PERCEPTION)
    {
        ...
        //ai_Debug("0i_replace_j_ai", "59", GetName(oCreature) + " is starting combat!");
...
void ai_SetMonsterEventScripts(object oCreature)
{
    //ai_Debug("0i_faerun", "92", "Changing monster " + GetName(oCreature) + "'s event scripts.");
...
void ai_SetAssociateEventScripts(object oCreature)
{
    //ai_Debug("0i_faerun", "154", "Changing associate " + GetName(oCreature) + "'s event scripts.");
    string sScript = GetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_HEARTBEAT);
    if(sScript == "nw_ch_ac1") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_HEARTBEAT, "0e_ch_1_hb");
    else if(sScript == "0e_ass_hrtbeat_1" || sScript == "0e_hen_hrtbeat_1") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_HEARTBEAT, "0e_ch_1_hb");
    ...
    else if(sScript == "0e_ass_onperce_2" || sScript == "0e_hen_onperce_2") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_NOTICE, "0e_ch_2_percept");
    ...
    else if(sScript == "0e_ass_onendrd_3" || sScript == "0e_hen_onendrd_3") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_END_COMBATROUND, "0e_ch_3_endround");
    ...
    else if(sScript == "0e_ass_ondialg_4" || sScript == "0e_hen_ondialg_4") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_DIALOGUE, "0e_ch_4_convers");
    ...
    else if(sScript == "0e_ass_onatked_5" || sScript == "0e_hen_onatked_5") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_MELEE_ATTACKED, "0e_ch_5_phyatked");
    ...
    else if(sScript == "0e_ass_ondmg_6" || sScript == "0e_hen_ondmg_6") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_DAMAGED, "0e_ch_6_damaged");
    ...
    else if(sScript == "0e_ass_ondstrb_8" || sScript == "0e_hen_ondstrb_8") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_DISTURBED, "0e_ch_8_disturb");
    ...
    else if(sScript == "0e_ass_onrest_a" || sScript == "0e_hen_onrest_a") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_RESTED, "0e_ch_a_rested");
    ...
    else if(sScript == "0e_ass_onspell_b" || sScript == "0e_hen_onspell_b") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_SPELLCASTAT, "0e_ch_b_castat");
    ...
    else if(sScript == "0e_ass_onblck_e" || sScript == "0e_hen_onblck_e") SetEventScript(oCreature, EVENT_SCRIPT_CREATURE_ON_BLOCKED_BY_DOOR, "0e_ch_e_blocked");
