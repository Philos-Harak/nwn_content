...
void CreateLabel(json jRow, string sLabel, string sId, float fWidth, float fHeight, int nHAlign = 0, int nVAlign = 0, string sTooltip = "");
...
// fHeight the height of the box.
// sTooltip is the tooltip bind value.
void CreateImage(json jRow, string sResRef, string sId, int nAspect, int nHAlign, int nVAlign, float fWidth, float fHeight, string sToolTip = "");
