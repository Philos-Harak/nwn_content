...
const int AI_MODE_HEALING_OFF       =   0x00000008; // Creature will not use healing items or spells.
//const int AI_MODE_ =                  0x00000010; // Not used.
//const int AI_MODE_ =                  0x00000020; // Not used.
//const int AI_MODE_ =                  0x00000040; // Not used.
//const int AI_MODE_ =                  0x00000080; // Not used.
//const int AI_MODE_ =                  0x00000100; // Not used.
