...
void main()
{
    ...
    {
        ai_Debug("xx_pc_2_percept", "25", GetName(oCreature) + " heard " +
                 GetName(GetLastPerceived ()) + ".");
    }
    if(GetLastPerceptionVanished ())
    {
        ai_Debug("xx_pc_2_percept", "30", GetName(oCreature) + " lost sight of " +
                 GetName(GetLastPerceived ()) + ".");
    } */
    object oLastPerceived = GetLastPerceived();
    //ai_Debug("xx_pc_2_percept", "34", "Enemy? " + IntToString(GetIsEnemy(oLastPerceived)) +
    ...
    if(GetLastPerceptionSeen())
    {
        ...
        //ai_Debug("xx_pc_2_percept", "40", GetName(oCreature) + " is starting combat!");
