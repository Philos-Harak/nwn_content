...
const string COLOR_WHITE = "999";       // <cÿÿÿ> <c\xFF\xFF\xFF> _Debug messages.
const string COLOR_GRAY = "666";        // <cªªª> <c\xAA\xAA\xAA> Server messages
const string COLOR_YELLOW = "990";      // <cÿÿ > <c\xFF\xFF\x20> Generic messages to players.
const string COLOR_DARK_YELLOW = "660"; // <c  ª> <c\xAA\xAA\x20>
const string COLOR_RED = "900";         // <cÿ  > <c\xFF\x20\x20> Negative message to players.
const string COLOR_DARK_RED = "600";    // <c  ª> <c\xAA\x20\x20>
const string COLOR_GREEN = "080";       // <c ÿ > <c\x20\xFF\x20> Positive message to players.
const string COLOR_DARK_GREEN = "060";  // <c ª > <c\x20\xAA\x20>
const string COLOR_BLUE = "009";        // <c  ÿ> <c\x20\x20\xFF>
const string COLOR_DARK_BLUE = "006";   // <c  ª> <c\x20\x20\xAA> In game descriptive text.
const string COLOR_CYAN = "099";        // <c ÿÿ> <c\x20\xFF\xFF>
const string COLOR_DARK_CYAN = "066";   // <c ªª> <c\x20\xAA\xAA>
const string COLOR_MAGENTA = "909";     // <cÿ ÿ> <c\xFF\x20\xFF>
const string COLOR_DARK_MAGENTA = "606";// <cª ª> <c\xAA\x20\xAA>
const string COLOR_LIGHT_MAGENTA = "868"; // <âcâ> <c\xAA\xE2\xAA> Combat text: Enemy name color.
const string COLOR_ORANGE = "950";      // <cÿª > <c\xFF\x8E\x20>
const string COLOR_DARK_ORANGE = "940"; // <cÿq > <c\xFF\x71\x20>  Combat text: base text color.
const string COLOR_GOLD = "860";        // <câª > <c\xE2\xAA\x20>
