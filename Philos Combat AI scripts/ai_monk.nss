...
// Script Name: ai_monk
//////////////////////////////////////////////////////////////////////////////////////////////////////
 ai script for creatures using the class Monk.
...
void main()
{
    ...
    // *************************  MELEE ATTACKS  *******************************
    if (!ai_GetIsMeleeWeapon (GetItemInSlot (INVENTORY_SLOT_RIGHTHAND))) ai_EquipBestMonkMeleeWeapon (oCreature, oTarget);
