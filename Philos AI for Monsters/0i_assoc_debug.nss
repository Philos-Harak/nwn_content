...
void ai_SelectAssociateCommand(object oCreature, object oCommander, int nCommand)
{
    ...
    switch(nCommand)
    {
        ...
        {
            ai_CastHealing(oCreature, 1, oMaster, ai_GetIsInCombat(oCreature));
            return;
        }
...
int ai_CheckForCombat(object oCreature)
{
    ...
    {
        ai_HaveCreatureSpeak(oCreature, 5, ":0:1:2:3:6:");
        ai_Debug("0i_associates", "591", GetName(oCreature) + " is starting combat!");
...
void ai_AssociateEvaluateNewThreat(object oCreature, object oLastPerceived)
{
    ...
    switch(nAction)
    {
        ...
        case ACTION_INVALID :
        {
            ...
            ai_Debug("0i_associate", "620", "nCombatWait: " + IntToString(nCombatWait));
            if(nCombatWait)
            {
