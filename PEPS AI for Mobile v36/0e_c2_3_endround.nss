...
void main()
{
    ...
    if(AI_DEBUG) ai_Debug("0e_c2_3_endround", "20", GetName(oCreature) + " ends combat round." +
    ...
    if(AI_DEBUG) ai_Debug("0e_c2_3_endround", "37", "nAction: " + IntToString(nAction));
    switch(nAction)
    {
        ...
        case ACTION_INVALID :
        {
            ...
            if(AI_DEBUG) ai_Debug("0e_c2_3_endround", "49", "nCombatWait: " + IntToString(nCombatWait));
            if(nCombatWait)
            {
